		...
		<div class="row">
			<div class="col-6">
				<form:form action="saveAccount" modelAttribute="account"
					...
					<div class="form-group row">
						<Label for="balance" class="col-6 col-form-label">Account
							Balance:</Label>
						<div class="col-6">
					...
					<div class="form-group row">
						<Label for="dateOfBirth" class="col-6 col-form-label">Account
							Holder DOB:</Label>
						<div class="col-6">
					...
					<div class="form-group row">
						<Label for="code" class="col-6 col-form-label">Account
							Code:</Label>
						<div class="col-6">
	...
	<form:form modelAttribute="account" action="saveAccount" method="post">
		<table>
			<tr>
				...
				<td><form:input size="30" path="accountNo" /> <form:errors
						path="accountNo" cssClass="error" /> <b><font color="red">
							${message} </font></b></td>
			</tr>
			<tr>
				<td><spring:message code="lbl.accountHolderName" />:</td>
				<td><form:input size="30" path="accountHolderName" /> <form:errors
						path="accountHolderName" cssClass="error" /></td>
			</tr>
			<tr>
				<td><spring:message code="lbl.balance" />:</td>
				<td><form:input size="30" path="balance" /> <form:errors
			...
			<tr>
				<td><spring:message code="lbl.code" />:</td>
				<td><form:input size="30" path="code" /> <form:errors
						path="code" cssClass="error" /></td>
			</tr>
			<tr>
